...
export default function Fale_conosco(){
  ...
  useEffect(() => {
      async function fetchData(){
        const url = "http://localhost:3333/fale_conosco"; //"http://localhost/Projeto_Pratico_Banco_Intermediario/Projeto_individual_Banco_Intermediario_Bianca/ClassMensagem.php";
  ...
  async function envioMensagem(event) {
      ...
      const url = "http://localhost:3333/fale_conosco/enviar"; //"http://localhost/Projeto_Pratico_Banco_Intermediario/Projeto_individual_Banco_Intermediario_Bianca/ClassMensagem1.php";
